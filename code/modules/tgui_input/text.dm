...
/datum/tgui_input_text/ui_data(mob/user)
	...
	if(!user.client || !user.client.prefs)
		...
		.["preferences"]["large_buttons"] = user.client.prefs.read_player_preference(/datum/preference/toggle/tgui_input_large)
		.["preferences"]["swapped_buttons"] = user.client.prefs.read_player_preference(/datum/preference/toggle/tgui_input_swapped)
	.["title"] = title
	if(timeout)
