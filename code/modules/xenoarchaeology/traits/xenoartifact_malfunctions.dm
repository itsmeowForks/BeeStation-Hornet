...
/datum/xenoartifact_trait/malfunction/absorbant
	...
	var/list/scrubbing = list(GAS_PLASMA, GAS_CO2, GAS_N2O, GAS_BZ, GAS_NITRYL, GAS_TRITIUM, GAS_HYPER_NOBLIUM, GAS_WATER_VAPOR, GAS_O2, GAS_N2, GAS_STIMULUM, GAS_PLUOXIUM)
