...
/datum/dynamic_ruleset
	...
	/// If set, there needs to be a certain amount of players doing those roles (among us the players who won't be drafted) for the rule to be drafted IMPORTANT: DOES NOT WORK ON ROUNDSTART RULESETS.
