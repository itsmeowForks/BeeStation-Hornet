SUBSYSTEM_DEF(lighting)
	...
	flags = SS_TICKER
	var/list/sources_queue = list() // List of lighting sources queued for update.
	var/list/corners_queue = list() // List of lighting corners queued for update.
	var/list/objects_queue = list() // List of lighting objects queued for update.
